  ...
  const projectsData = [
    {
      ...
      description:
        "Built a full-stack logistics marketplace with bidding system and end-to-end shipment workflow management. (SvelteKit, Supabase, PostgreSQL, Google Maps API, Cloudflare Pages, Node.js).",
    ...
    },
    {
      ...
      heading: "Portfolio",
      description:
        "A dynamic personal portfolio website designed in Figma and built with HTML, CSS, and JavaScript.",
  ...
  return (
    ...
    >
      <motion.h2 variants={cardVariants} className="section-title">
        My <span className="highlight_skill">P</span>rojects
      </motion.h2>
      <motion.p variants={cardVariants} className="section-subtitle">
        A Selection Of My Best Work
      </motion.p>
      <motion.div variants={cardVariants} className="dots">
        <span></span>
        <span></span>
        <span></span>
      </motion.div>
